...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.8]{figs/gradients.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=1]{figs/overallframework.png}
...
% \bibitem{Alharbi2017}
% H. Alharbi and K. Bhattacharya, "Stochastic Optimal Planning of Battery Energy Storage Systems for Isolated Microgrids," in IEEE Transactions on Sustainable Energy, vol. 9, no. 1, pp. 211-227, Jan. 2018.
